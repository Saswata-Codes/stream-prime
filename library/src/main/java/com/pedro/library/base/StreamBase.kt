...
abstract class StreamBase(
  ...
  fun prepareVideo(
    ...
    if (videoResult) {
      ...
      // Don't set portrait mode based on rotation to prevent forced screen orientation
      // val isPortrait = rotation == 90 || rotation == 270
      // glInterface.setIsPortrait(isPortrait)
      // Don't set camera orientation based on rotation to prevent forced screen orientation
